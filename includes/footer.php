    ...
    <div class="container">
        <div class="footer-grid">
            ...
            <div class="footer-links">
                ...
                <a href="ai-software-development.php">AI Software Development</a>
                <a href="web-application-development.php">Web Applications</a>
                <a href="mobile-application-development.php">Mobile Apps</a>
                <a href="custom-software.php">Custom Software</a>
                <a href="solutions.php">Automation & Integration</a>
            </div>
